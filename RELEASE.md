...
Release target in this cycle: `v1.0.0rc3`
...
python -m pip install dist/datefinder-1.0.0rc3*.whl
python - <<'PY'
import datefinder
...
python -m pip install dist/datefinder-1.0.0rc3.tar.gz
python - <<'PY'
import datefinder
...
- Update `docs/releases/1.0.0rc3.md`.
...
- Preflight publish to TestPyPI before final PyPI release:
  ...
  - Validate install on clean machine:
    ...
    python -m pip install \
      ...
      --pre datefinder==1.0.0rc3
    ```
- Tag release (`v1.0.0rc3`).
