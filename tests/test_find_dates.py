...
@pytest.mark.parametrize('input_text,date_string,expected_indices,expected_date', [
    ## English Dates
...
def test_find_date_strings(input_text, date_string, expected_indices, expected_date):
